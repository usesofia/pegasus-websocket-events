...
class SyncBankTransactionsWebsocketEvents {
}
exports.SyncBankTransactionsWebsocketEvents = SyncBankTransactionsWebsocketEvents;
SyncBankTransactionsWebsocketEvents.Started = (_a = class {
    },
    __setFunctionName(_a, "Started"),
    _a.eventName = 'sync-bank-transactions-started',
    ...
    _a.EventDataEntity = class extends (0, nestjs_zod_1.createZodDto)(_a.EventDataSchema) {
        ...
        static build(input) {
            return (0, entity_utils_1.safeInstantiateEntity)(SyncBankTransactionsWebsocketEvents.Started.EventDataEntity, input);
        }
    },
    _a);
SyncBankTransactionsWebsocketEvents.Progress = (_b = class {
    },
    __setFunctionName(_b, "Progress"),
    _b.eventName = 'sync-bank-transactions-progress',
    ...
    _b.EventDataEntity = class extends (0, nestjs_zod_1.createZodDto)(_b.EventDataSchema) {
        ...
        static build(input) {
            return (0, entity_utils_1.safeInstantiateEntity)(SyncBankTransactionsWebsocketEvents.Progress.EventDataEntity, input);
        }
    },
    _b);
SyncBankTransactionsWebsocketEvents.Finished = (_c = class {
    },
    __setFunctionName(_c, "Finished"),
    _c.eventName = 'sync-bank-transactions-finished',
    ...
    _c.EventDataEntity = class extends (0, nestjs_zod_1.createZodDto)(_c.EventDataSchema) {
        ...
        static build(input) {
            return (0, entity_utils_1.safeInstantiateEntity)(SyncBankTransactionsWebsocketEvents.Finished.EventDataEntity, input);
        }
    },
    _c);
